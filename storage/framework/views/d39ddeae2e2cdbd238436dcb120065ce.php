...
<div class="auth-container">
    <div class="auth-box" style="background-color: rgba(155, 167, 129, 0.85); backdrop-filter: blur(8px); color: white; border: none; max-width: 500px;">
        ...
        <form method="POST" action="<?php echo e(route('privacidad.aceptar')); ?>">
            <?php echo csrf_field(); ?>
...
<style>
    ...
    .auth-container {
        background-image: url('<?php echo e(asset('images/image_0d7cc0.jpg')); ?>') !important;
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\EcoGuide\resources\views/auth/privacidad.blade.php ENDPATH**/ ?>