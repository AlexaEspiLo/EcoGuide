...
<div class="tip-detail-container" style="background-image: url('/images/bg-home.jpeg')">
    ...
    <div class="author-info">
        <img src="<?php echo e(asset('images/bg-login.jpg')); ?>" alt="author" class="author-avatar">
    ...
    <div class="tip-detail-card">
        ...
        <div class="description">
            ...
            <a href="<?php echo e(asset('images/bg-login.jpg')); ?>" data-fancybox data-caption="Tip Image">
                <img class="tip-image" src="<?php echo e(asset('images/bg-login.jpg')); ?>" alt="Single image" />
            </a>
        </div>
