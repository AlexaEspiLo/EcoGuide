...
<div class="auth-container">
    <div class="auth-box" style="background-color: rgba(144, 161, 126, 0.85); padding: 3rem; border-radius: 40px; text-align: center;">
        ...
        <p style="color: white; margin-bottom: 2rem; font-size: 0.9rem;">We'll send you an email to help you recover your account</p>
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <div style="margin-bottom: 1.5rem; text-align: left;">
                <label style="color: #354024; font-weight: bold; font-size: 0.8rem;">Email Address</label>
